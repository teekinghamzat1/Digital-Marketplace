  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative bg-primary text-white p-4 rounded-2xl shadow-2xl shadow-primary/40 border border-white/20 group-hover:rotate-12 transition-transform duration-500">
