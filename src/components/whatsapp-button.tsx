...
export function WhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-24 right-6 z-40 bg-primary text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group flex items-center justify-center border-2 border-white/20"
