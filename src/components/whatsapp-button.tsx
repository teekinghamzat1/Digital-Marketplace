  ...
  return (
    ...
    >
      <div className="relative">
        <div className="absolute -inset-4 bg-primary/20 rounded-full blur-xl group-hover:bg-primary/30 animate-pulse transition-all"></div>
        <div className="relative bg-primary text-white p-4 rounded-2xl shadow-2xl shadow-primary/40 border border-white/20 group-hover:rotate-12 transition-transform duration-500 flex items-center justify-center">
          <svg 
            width="28" 
            height="28" 
            viewBox="0 0 24 24" 
      ...
      <div className="bg-surface/80 backdrop-blur-md border border-border-default py-2.5 px-5 rounded-2xl shadow-xl opacity-0 translate-x-[20px] group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 pointer-events-none text-right">
